package com.bcsd.common.utils.poi;
...
import com.bcsd.common.annotation.Excel.ColumnType;
import com.bcsd.common.annotation.Excel.Type;
import com.bcsd.common.annotation.Excels;
import com.bcsd.common.config.BcsdConfig;
import com.bcsd.common.core.domain.AjaxResult;
import com.bcsd.common.core.text.Convert;
import com.bcsd.common.exception.UtilException;
import com.bcsd.common.utils.DateUtils;
import com.bcsd.common.utils.DictUtils;
import com.bcsd.common.utils.StringUtils;
import com.bcsd.common.utils.file.FileTypeUtils;
import com.bcsd.common.utils.file.FileUtils;
import com.bcsd.common.utils.file.ImageUtils;
import com.bcsd.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    {
        String downloadPath = BcsdConfig.getDownloadPath() + filename;
     ...
     * @return
     */
    public static List<String> getHead(String title) {
     ...
     */
    public static void uploadExcelAboutUser(HttpServletRequest request, HttpServletResponse response, String fileName, List<String> columnList, List<List<String>> dataList) {
        //声明输出流
        ...
        try {
            ...
            if (dataList != null && dataList.size() > 0) {
                ...
                for (int i = 0; i < dataList.size(); i++) {
                    ...
                    //内层for循环创建每行对应的列，并赋值
                    for (int j = 0; j < dataList.get(i).size(); j++) {//由于多了一列序号列所以内层循环从-1开始

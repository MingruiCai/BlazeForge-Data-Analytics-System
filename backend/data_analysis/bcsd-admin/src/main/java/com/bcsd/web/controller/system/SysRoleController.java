...
import com.bcsd.framework.web.service.SysPermissionService;
import com.bcsd.framework.web.service.TokenService;
import com.bcsd.system.domain.SysUserRole;
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role)
    {
        ...
        {
            return AjaxResult.error("新增角色'" + role.getRoleName() + "'失败，角色标识已存在");
        }
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        {
            return AjaxResult.error("修改角色失败，角色标识已存在");
        }
        ...
        return AjaxResult.error("修改角色失败，请联系管理员");
    }
